...
/eceived from PID <el pid del remitente>"
...
int main()
{
   ...
   if (sigaction(SIGUSR1, &sa, NUL*Modifica tu server para que responda tanto a señales SIGUSR1 como a SIGUSR2
